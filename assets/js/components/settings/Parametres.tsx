  ...
  return (
    <section id="parametres">
      ...
      <div className="navigation">
        <div className={location.pathname === "/dashboard/settings/general" ? "param-nav-active" : ""}
            onClick={() => navigate("general")}
        >
          <p>GENERAL</p>
        </div>
        <div
          className={location.pathname === "/dashboard/settings/linked-apps" ? "param-nav-active" : ""}
